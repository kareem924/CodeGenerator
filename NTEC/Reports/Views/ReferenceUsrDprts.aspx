<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReferenceUsrDprts.aspx.cs" Inherits="NTEC.Reports.Views.ReferenceUsrDprts" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<head runat="server">
    <title>All Generated References Report</title>
            ...
            <div runat="server" dir="<%$ Resources: Resource, Direction %>" style="margin-bottom: 15px; margin-top: 15px">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <asp:Label runat="server" ID="UserNameLbl" Text="User Name :" meta:resourcekey="UserNameLblResource1"></asp:Label>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <asp:Label runat="server" ID="FrmLbl" Text="From : " meta:resourcekey="FrmLblResource1"></asp:Label>
                ...
                <div class="row">
                    <div class="text-center">
                        <asp:Button ID="Button1"  CssClass="btn btn-success" runat="server" Text="Show Report" OnClientClick="return checkForm();" OnClick="Button1_Click" meta:resourcekey="Button1Resource1" />
                    </div>
                </div>
            </div>
            <div class="row">
                <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" ZoomMode="PageWidth"
                    SizeToReportContent="True" WaitMessageFont-Size="14pt" meta:resourcekey="ReportViewer1Resource1">
                    <LocalReport ReportPath="Reports\ReferenceByUserOrDeprt.rdlc">
                    </LocalReport>
                </rsweb:ReportViewer>
